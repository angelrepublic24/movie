...
function borrar_imagenes($ruta,$extension)
	...
	function miniatura($titulo,$descripcion,$urlImagen,$urlPost){
		echo "
		<div class='py-1 col-6 col-xs-3 col-sm-3 col-md-3 col-xl-2 stats-col' style='padding-right: 3px; padding-left: 3px;'>
			<div class='img-post'>
				<a href='".$urlPost."' title='".$titulo."' alt='".$titulo."'>
					<img class='img_miniatura' alt='".$titulo."' src='".$urlImagen."'>
				</a>
			</div>
			<div class='text-center'>
				<a class='titulo_miniatura' href='#' title='".$titulo."'>
					".$titulo."
				</a>
			</div>
		</div>";
	...
	function cortarString ($string, $largo) { 
      	$marca = "<!--corte-->"; 
